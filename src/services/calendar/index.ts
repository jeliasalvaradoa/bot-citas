...
const getCurrentCalendar = async (): Promise<string> => {
    const dataCalendarApi = await fetch('https://hook.us1.make.com/2jmwfcqtao3etdc5nda624pexhi0wj9j')
...
const appToCalendar = async (text: string) => {
    try {
        ...
        console.log(payload)
        const dataApi = await fetch('https://hook.us1.make.com/c4bu8m69fkx9vm82l7wyus8o5a4af1k8', {
            method: 'POST',
            headers: {
